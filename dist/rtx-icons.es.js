...
const u = ["width", "height"], a = ["fill"], _ = /* @__PURE__ */ n({
...
}, C = ["width", "height"], f = ["fill"], w = /* @__PURE__ */ n({
  __name: "Close",
  props: {
    size: { default: 10 },
    color: {}
  ...
  install(o) {
    o.component("rtx-back", Z);
  }
}, P = ["width", "height", "fill"], D = ["fill"], E = /* @__PURE__ */ n({
  __name: "Search",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-search", E);
  }
}, R = ["width", "height", "fill"], b = ["fill"], U = /* @__PURE__ */ n({
  __name: "Demap",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-remap", T);
  }
}, N = ["width", "height", "fill"], j = ["fill"], q = ["fill"], F = /* @__PURE__ */ n({
  __name: "Chain",
  props: {
    size: { default: 12 },
    color: {}
...
}, d1 = ["width", "height", "fill"], C1 = ["fill"], f1 = /* @__PURE__ */ n({
  __name: "Trigger",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-updater", z1);
  }
}, V1 = ["width", "height"], x1 = ["fill"], M1 = /* @__PURE__ */ n({
  __name: "Erase",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-erase", M1);
  }
}, B1 = ["width", "height", "fill"], P1 = ["fill"], D1 = /* @__PURE__ */ n({
  __name: "Menu",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install: (o) => {
    o.use(d), o.use(p), o.use(m), o.use(V), o.use(B), o.use(k), o.use(y), o.use(I), o.use(G), o.use(Q), o.use(o1), o.use(s1), o.use(c1), o.use(_1), o.use(w1), o.use(v1), o.use($1), o.use(Z1), o.use(E1);
  }
};
export {
  R1 as default
