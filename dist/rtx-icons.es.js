...
const h = ["width", "height", "fill"], u = ["fill"], a = /* @__PURE__ */ n({
...
}, q = ["width", "height", "fill"], I = ["fill"], N = ["fill"], F = /* @__PURE__ */ n({
  __name: "Chain",
  props: {
    size: { default: 12 },
    color: {}
...
}, q1 = ["width", "height"], I1 = ["fill"], N1 = ["fill"], F1 = /* @__PURE__ */ n({
  __name: "Calendar",
  props: {
    size: { default: 12 },
    color: {}
...
}, F2 = ["width", "height", "fill"], G2 = ["fill"], J2 = /* @__PURE__ */ n({
  __name: "Tendency",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-tendency", J2);
  }
}, Q2 = {
  install: (o) => {
    o.use(_), o.use(w), o.use(v), o.use(Z), o.use(B), o.use(k), o.use(j), o.use(T), o.use(G), o.use(Q), o.use(o1), o.use(s1), o.use(r1), o.use(a1), o.use(p1), o.use(V1), o.use(M1), o.use(x1), o.use(D1), o.use(j1), o.use(T1), o.use(G1), o.use(Q1), o.use(o2), o.use(s2), o.use(r2), o.use(d2), o.use(g2), o.use(L2), o.use(z2), o.use(y2), o.use(E2), o.use(S2), o.use(N2), o.use(K2);
  }
};
export {
  Q2 as default
