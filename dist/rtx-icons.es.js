...
const u = ["width", "height"], a = ["fill"], _ = /* @__PURE__ */ n({
  __name: "Add",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-add", _);
  }
}, p = ["width", "height"], d = ["fill"], f = /* @__PURE__ */ n({
  __name: "Close",
  props: {
    size: { default: 10 },
    color: {}
...
}, L = ["width", "height", "fill"], V = ["fill"], z = /* @__PURE__ */ n({
  __name: "Left",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-left", z);
  }
}, M = ["width", "height", "fill"], Z = ["fill"], x = /* @__PURE__ */ n({
  __name: "Back",
  props: {
    size: { default: 12 },
    color: {}
...
}, A = ["width", "height", "fill"], j = ["fill"], I = /* @__PURE__ */ n({
  __name: "Remap",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-remap", I);
  }
}, T = ["width", "height", "fill"], N = ["fill"], q = ["fill"], F = /* @__PURE__ */ n({
  __name: "Chain",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-chain", F);
  }
}, J = ["width", "height", "fill"], K = ["fill"], O = /* @__PURE__ */ n({
  __name: "Right",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-up", a1);
  }
}, C1 = ["width", "height", "fill"], p1 = ["fill"], d1 = /* @__PURE__ */ n({
  __name: "Trigger",
  props: {
    size: { default: 12 },
    color: {}
...
}, v1 = ["width", "height", "fill"], L1 = ["fill"], V1 = /* @__PURE__ */ n({
  __name: "Updater",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-updater", V1);
  }
}, $1 = ["width", "height"], M1 = ["fill"], Z1 = /* @__PURE__ */ n({
  __name: "Erase",
  props: {
    size: { default: 12 },
    color: {}
...
}, A1 = ["width", "height"], j1 = ["fill"], I1 = /* @__PURE__ */ n({
  __name: "User",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-user", I1);
  }
}, T1 = ["width", "height"], N1 = ["fill"], q1 = ["fill"], F1 = /* @__PURE__ */ n({
  __name: "Calendar",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install(o) {
    o.component("rtx-calendar", F1);
  }
}, J1 = ["width", "height"], K1 = ["fill"], O1 = /* @__PURE__ */ n({
  __name: "Apply",
  props: {
    size: { default: 12 },
    color: {}
  ...
  install: (o) => {
    o.use(C), o.use(w), o.use(v), o.use($), o.use(B), o.use(y), o.use(b), o.use(S), o.use(G), o.use(Q), o.use(o1), o.use(s1), o.use(c1), o.use(_1), o.use(f1), o.use(m1), o.use(z1), o.use(x1), o.use(D1), o.use(b1), o.use(S1), o.use(G1), o.use(Q1), o.use(o2), o.use(s2), o.use(c2);
  }
};
export {
  u2 as default
